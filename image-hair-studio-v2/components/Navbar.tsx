      ...
      <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="hidden md:flex items-center">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-5 py-2.5 border border-ink/80 text-[11px] uppercase tracking-widest-x text-ink hover:bg-ink hover:text-cream transition-colors duration-500"
            >
              Book
